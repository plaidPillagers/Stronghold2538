...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveSystemLeftMotor = new CANTalon(0);
        LiveWindow.addActuator("driveSystem", "LeftMotor", driveSystemLeftMotor);
        
        driveSystemRightMotor = new CANTalon(1);
        LiveWindow.addActuator("driveSystem", "RightMotor", driveSystemRightMotor);
        ...
        liftscissors1 = new CANTalon(2);
        LiveWindow.addActuator("lift", "scissors1", liftscissors1);
        
        liftscissors2 = new CANTalon(4);
