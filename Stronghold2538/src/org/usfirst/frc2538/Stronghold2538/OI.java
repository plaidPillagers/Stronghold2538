...
public class OI {
    ...
    public JoystickButton moveBIMIn;
    public JoystickButton moveBIMOut;
    public JoystickButton leftLift;
    public JoystickButton rightLift;
    public JoystickButton scissorsUpButton;
    public JoystickButton scissorsDownButton;
    public JoystickButton bIMJoystickMove;
    ...
    public OI() {
        ...
        bIMJoystickMove = new JoystickButton(secondaryStick, 1);
        bIMJoystickMove.whileHeld(new joystickBIM());
        scissorsDownButton = new JoystickButton(secondaryStick, 11);
        scissorsDownButton.whileHeld(new scissorsDown());
        scissorsUpButton = new JoystickButton(secondaryStick, 12);
        scissorsUpButton.whileHeld(new scissorsUp());
        rightLift = new JoystickButton(secondaryStick, 10);
        rightLift.whileHeld(new rightScissorsLift());
        leftLift = new JoystickButton(secondaryStick, 9);
        leftLift.whileHeld(new leftScissorsLift());
        moveBIMOut = new JoystickButton(secondaryStick, 24);
        moveBIMOut.whileHeld(new bimOut());
        moveBIMIn = new JoystickButton(secondaryStick, 19);
        moveBIMIn.whileHeld(new bimIn());
        ...
        scissorsLift = new JoystickButton(secondaryStick, 22);
