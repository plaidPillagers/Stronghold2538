...
public class OI {
    ...
    public OI() {
        ...
        wheelStop = new JoystickButton(secondaryStick, 1);
        wheelStop.whileHeld(new BIMStop());
        wheelEject = new JoystickButton(secondaryStick, 1);
        wheelEject.whileHeld(new BIMEject());
        wheelIntake = new JoystickButton(secondaryStick, 1);
