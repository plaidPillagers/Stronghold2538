...
public class turnLeftGyro extends Command {
    ...
    public turnLeftGyro(double angle) {
    	this.angle = angle;
    ...
    protected void initialize() {
    	Robot.driveSystem.setLeftAngle(angle);
    ...
    protected void execute() {
    	finished = Robot.driveSystem.autoGyroLeftTurn();
    	SmartDashboard.putString("autoCommand", "turnLeftGyro");
    }
