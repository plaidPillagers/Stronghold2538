...
public class AutonomousCommandGroup extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	addSequential(new driveStraightWithEncoder(), 5); //timed out for testing purposes only
    	addSequential(new stopDriving(), 1.5);
    	addSequential(new turnGyro());
    	addSequential(new stopDriving(), 1.5);
    		//addSequential(new driveStraight());
    	addSequential(new autonomousToGoal(), 2.5); //timed out for testing purposes only
    	addSequential(new stopDriving(), 1.5);
