...
public class AutonomousCommandGroup extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	*/
    	...
    	if (Robot.driveSystem.ultraDistance < 25) {
    	...
    	else if (Robot.driveSystem.ultraDistance < 78 && Robot.driveSystem.ultraDistance > 25) {
    	...
    	else if (Robot.driveSystem.ultraDistance > 78 && Robot.driveSystem.ultraDistance < 130) {
    		addSequential(new driveStraightWithEncoder(-.8, -130), 3); //timed out for testing purposes only
        	addSequential(new stopDriving(), .25);
         	addSequential(new turnLeftGyro(10), 1);
        	addSequential(new turnRightGyro(10), 1);	
    	...
    	else if (Robot.driveSystem.ultraDistance > 130 && Robot.driveSystem.ultraDistance < 184) {
    		addSequential(new driveStraightWithEncoder(-.8, -180));
        	addSequential(new stopDriving(), .1);
        	addSequential(new driveForwardNoSensors(), 3);
        	addSequential(new stopDriving());
		}
    	else if (Robot.driveSystem.ultraDistance > 184 && Robot.driveSystem.ultraDistance < 237) {
    		addSequential(new driveStraightWithEncoder(-.8, -130), 3); //timed out for testing purposes only
        	addSequential(new stopDriving(), .25);
        	addSequential(new turnRightGyro(-10), 1);
        	addSequential(new turnLeftGyro(-10), 1);
